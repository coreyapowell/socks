...
function generateHTML(getpath, i) {
    ...
    html.push('It is because I have to restart the script. Something is out of order in WSL.');
    html.push('Each client is going to need its own thread somehow, so we are pushing FDs');
